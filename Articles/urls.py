...
from .views import Articles_view , detail_alert , detail_slider , detail_article, category_alert , category_slider , category_article , AuthorList , detail_article_preview
